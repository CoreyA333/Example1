 ...
 * 
 */
$page_title = "PHP Online Gamestore Login";
...
if ($login_status == 1) {
    echo "<p>You are logged is as " . $_SESSION['login'] . ".</p>";
    ...
    <div class="login">
        <form method='post' action='login.php'>
            <table>
                ...
                <tr>
                    <td colspan='2' style='padding: 10px 0 0 85px' class="gamestore-button">
                        <input type='submit' value='  Login  '>
                        <input type="submit" name="Cancel" value="Cancel" onclick="window.location.href = 'listgames.php'" />
                    </td>
                </tr>
            </table>
        </form>
    ...
    <div class="registration">
        <form action="register.php" method="post">
            <table>
                ...
                <tr>
                    <td colspan="2" style='padding: 10px 0 0 80px' class="gamestore-button">
